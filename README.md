...
Сайт — статична збірка; каталог додає власний браузерний JS (фільтри,
кошик, генерація PDF), без власного бекенду. Деталі в
[`docs/00-what-neurica-is.md`](./docs/00-what-neurica-is.md) і
