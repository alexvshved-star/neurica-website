...
test('pending prices and finishes remain visible, with no values inferred from reference prices',()=>{
 const products=priceListProducts({...snapshot,products:snapshot.products.map(p=>p.id==='sm-9817c44dde0c'?{...p,pricePending:true,priceSlabCents:null,priceM2Cents:null}:p.name==='Metropolis Oyster'?{...p,finishPending:true}:p)},'sm-quartz');
